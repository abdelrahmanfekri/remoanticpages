        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-8 animate-fade-up">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 pt-4 sm:pt-6 px-4">
              <Link
                href="/login"
                className="group relative bg-gradient-to-r from-rose-500 via-pink-500 to-purple-500 text-white px-6 sm:px-8 md:px-10 py-4 sm:py-5 rounded-xl soft-glow hover:scale-105 active:scale-95 transition-all duration-300 font-semibold text-base sm:text-lg shadow-2xl overflow-hidden touch-manipulation text-center"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  <Sparkles size={18} className="sm:w-5 sm:h-5 group-hover:rotate-180 transition-transform duration-500" />
              ...
              <Link
                href="/templates"
                className="group bg-white/90 backdrop-blur-sm text-rose-600 px-6 sm:px-8 md:px-10 py-4 sm:py-5 rounded-xl border-2 border-rose-200 hover:border-rose-400 hover:bg-white active:scale-95 transition-all duration-300 font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl hover:scale-105 touch-manipulation text-center"
              >
